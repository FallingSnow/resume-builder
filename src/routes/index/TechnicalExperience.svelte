		...
		<div class="row">
			<div>
				<header>
					<Icon>star</Icon>
					<div>
						<h5>Advanced<br /><small>2+ years professionally</small></h5>
					</div>
				</header>
				<div class="mozaic">
			...
			<div>
				...
				<div class="mozaic">
					{#each Array($numTechAdvanced) as _, index (index)}
						<Label key={`techAdvanced[${index}]`} placeholder="Technology" hints={[...languageList, ...technologyList]} />
					{/each}
		...
		<div class="row">
			<div>
				<header>
					...
					<div>
						<h5>Intermediate<br /><small>&lt; 2 years professionally</small></h5>
					</div>
				</header>
                <div class="mozaic">
			...
			<div>
                ...
                <div class="mozaic">
                    {#each Array($numTechIntermediate) as _, index (index)}
                        <Label key={`techIntermediate[${index}]`} placeholder="Technology" hints={[...languageList, ...technologyList]} />
                    {/each}
		...
		<div class="row">
			<div>
				<header>
					...
					<div>
						<h5>Basic<br /><small>Internships / personal projects</small></h5>
					</div>
				</header>
                <div class="mozaic">
			...
			<div>
                ...
                <div class="mozaic">
                    {#each Array($numTechBasic) as _, index (index)}
                        <Label key={`techBasic[${index}]`} placeholder="Technology" hints={[...languageList, ...technologyList]} />
                    {/each}
